...
SketchBase.prototype = {
	...
	,setup: function() {
		if(this.isDebug) {
			haxe_Log.trace("SETUP :: " + this.toString() + " -> override public function draw()",{ fileName : "Sketch.hx", lineNumber : 577, className : "SketchBase", methodName : "setup"});
		}
	}
	,draw: function() {
		if(this.isDebug) {
			haxe_Log.trace("DRAW :: " + this.toString() + " -> override public function draw()",{ fileName : "Sketch.hx", lineNumber : 585, className : "SketchBase", methodName : "draw"});
		}
	}
	,__export: function() {
	}
	...
	,update: function() {
		...
		if(this.settings.get_type() == "svg") {
			...
			while(_g2 < _g11) {
				...
				haxe_Log.trace(base1.type,{ fileName : "Sketcher.hx", lineNumber : 408, className : "Sketcher", methodName : "update"});
...
cc_draw_Text.prototype = {
	...
	,draw: function() {
		if(this._ctx != null) {
			...
			var isLines1 = this.splitLines();
			var text = this._sketcher.makeText(this._text,this.get__x(),this.get__y());
			if(this.get__id() != null) {
				text.set_id(this.get__id());
			}
			if(this._color != null) {
				text.set_fill(cc_util_ColorUtil.getColourObj(this._color,this.get__alpha()));
			}
			text.set_fontSize("" + this.get__size() + "px");
			text.set_fontFamily("" + this._font);
			text._textAlign = this._textAlign;
			text._textBaseline = this._textBaseline;
			if(this.fontWeight != null) {
				text.set_fontWeight("" + this._fontWeight);
			}
			this._hackText = text;
		}
		return this;
	...
	,updateProperties: function(time) {
		...
		while(n.hasNext()) {
			...
			if(this._isOrbit) {
				...
				haxe_Log.trace("" + n1 + " == \"angle\" : " + Std.string(n1 == "angle"),{ fileName : "cc/lets/Go.hx", lineNumber : 601, className : "cc.lets.Go", methodName : "updateProperties"});
...
var cc_model_constants_PaperSize = $hxEnums["cc.model.constants.PaperSize"] = { __ename__ : true, __constructs__ : ["A6","A5","A4","A3","A2","A1"]
	,A6: {_hx_index:0,__enum__:"cc.model.constants.PaperSize",toString:$estr}
	,A5: {_hx_index:1,__enum__:"cc.model.constants.PaperSize",toString:$estr}
	,A4: {_hx_index:2,__enum__:"cc.model.constants.PaperSize",toString:$estr}
	,A3: {_hx_index:3,__enum__:"cc.model.constants.PaperSize",toString:$estr}
	,A2: {_hx_index:4,__enum__:"cc.model.constants.PaperSize",toString:$estr}
	,A1: {_hx_index:5,__enum__:"cc.model.constants.PaperSize",toString:$estr}
};
...
draw_Base.prototype = {
	...
	,clone: function() {
		haxe_Log.trace("WIP",{ fileName : "draw/Base.hx", lineNumber : 119, className : "draw.Base", methodName : "clone"});
...
draw_Group.prototype = $extend(draw_Base.prototype,{
	...
	,test: function() {
		haxe_Log.trace("test if casting works",{ fileName : "draw/Group.hx", lineNumber : 54, className : "draw.Group", methodName : "test"});
	}
	,get_arr: function() {
		return this.arr;
	}
...
draw_Line.prototype = $extend(draw_Base.prototype,{
	...
	,__class__: draw_Line
	,__properties__: $extend(draw_Base.prototype.__properties__,{set_lineCap:"set_lineCap",get_lineCap:"get_lineCap",set_y2:"set_y2",get_y2:"get_y2",set_x2:"set_x2",get_x2:"get_x2"})
});
...
draw_PolyLine.prototype = $extend(draw_Base.prototype,{
	svg: function(settings) {
		...
		if(this.getTransform() != "") {
			haxe_Log.trace(this.getTransform(),{ fileName : "draw/PolyLine.hx", lineNumber : 26, className : "draw.PolyLine", methodName : "svg"});
			this.xml.set("transform",this.getTransform());
		}
		return haxe_xml_Printer.print(this.xml);
	}
...
draw_Polygon.prototype = $extend(draw_Base.prototype,{
	...
	,getPoint: function(id) {
		if(id * 2 > this.get_arr().length) {
			haxe_Log.trace("not in this length",{ fileName : "draw/Polygon.hx", lineNumber : 42, className : "draw.Polygon", methodName : "getPoint"});
		}
...
draw_Rectangle.prototype = $extend(draw_Base.prototype,{
	...
	,ctx: function(ctx) {
		...
		haxe_Log.trace(cc_util_ColorUtil.getColourObj(color,this.get_opacity()),{ fileName : "draw/Rectangle.hx", lineNumber : 76, className : "draw.Rectangle", methodName : "ctx"});
		haxe_Log.trace(color,{ fileName : "draw/Rectangle.hx", lineNumber : 77, className : "draw.Rectangle", methodName : "ctx"});
		haxe_Log.trace(this.get_fill(),{ fileName : "draw/Rectangle.hx", lineNumber : 78, className : "draw.Rectangle", methodName : "ctx"});
		ctx.beginPath();
		if(this.get_radius() == null) {
...
draw_Text.prototype = $extend(draw_Base.prototype,{
	...
	,ctx: function(ctx) {
		haxe_Log.trace("needs work!",{ fileName : "draw/Text.hx", lineNumber : 140, className : "draw.Text", methodName : "ctx"});
	}
	,convertTextAlign: function() {
		...
		default:
			this.set_textAnchor("start");
			haxe_Log.trace("case '" + this._textAlign + "': trace ('" + this._textAlign + "');",{ fileName : "draw/Text.hx", lineNumber : 154, className : "draw.Text", methodName : "convertTextAlign"});
		}
	}
	,convertTextBaseline: function() {
		...
		default:
			...
			haxe_Log.trace("case '" + this._textBaseline + "': trace ('" + this._textBaseline + "');",{ fileName : "draw/Text.hx", lineNumber : 168, className : "draw.Text", methodName : "convertTextBaseline"});
		}
	}
	...
	,__class__: draw_Text
	,__properties__: $extend(draw_Base.prototype.__properties__,{set_style:"set_style",get_style:"get_style",set_dominantBaseline:"set_dominantBaseline",get_dominantBaseline:"get_dominantBaseline",set_alignmentBaseline:"set_alignmentBaseline",get_alignmentBaseline:"get_alignmentBaseline",set_textAnchor:"set_textAnchor",get_textAnchor:"get_textAnchor",set_fontWeight:"set_fontWeight",get_fontWeight:"get_fontWeight",set_fontFamily:"set_fontFamily",get_fontFamily:"get_fontFamily",set_fontSize:"set_fontSize",get_fontSize:"get_fontSize",set_str:"set_str",get_str:"get_str"})
});
...
util_TextUtil.prototype = {
	...
	,getLines: function(text,maxWidth) {
		...
		while(_g < _g1) {
			...
			if(isDebug) {
				haxe_Log.trace("\"" + _text1 + "\".width: " + width + " / " + maxWidth,{ fileName : "util/TextUtil.hx", lineNumber : 194, className : "util.TextUtil", methodName : "getLines"});
			}
			if(width < maxWidth) {
				currentLine += " " + word;
			} else {
